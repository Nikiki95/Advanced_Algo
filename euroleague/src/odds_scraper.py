"""EuroLeague odds scraper with line shopping support."""
...
try:
    from euroleague.config import THEODDS_API_KEY, THEODDS_BASE_URL, SPORT_KEY, REGIONS
except Exception:
